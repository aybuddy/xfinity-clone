          ...
          <div className='flex justify-between items-center flex-2'>
            <ul className='flex m-0 p-0 list-none items-center flex-1auto'>
              <li>
                <Link
                  to='/'
                  className='no-underline text-white ml-0 m-3 tracking-wide text-xs uppercase'
                >
                  Shop
                </Link>
              </li>
              <li>
                <Link
                  to='/'
                  className='no-underline text-linkColor ml-0 m-3 tracking-wide text-xs uppercase'
                >
                  My Account
                </Link>
              </li>
            ...
            <ul className='flex m-0 p-0 list-none items-center text-right'>
              <li>
                <Link to='/' className='p-0 text-center w-6 mt-0 mx-3'>
            ...
            <nav className='flex items-center flex-75'>
              ...
              <ul className='flex p-0 m-0 list-none items-center'>
                <li className='flex items-center h-full flex-initial'>
                  <Link
                    to='/'
                    className='cursor-pointer m-0 mr-1 ml-0 py-1 px-3 text-linkColor text-18'
                  >
                    Internet
                  </Link>
                </li>
              ...
              <ul className='flex p-0 m-0 list-none items-center'>
                ...
                <li className='flex items-center h-full flex-initial'>
                  <div className='text-linkColor text-sm tracking-wider my-0 mr-0 ml-1'>
                    <Link to='/' className='text-white rounded-sm p-1.5'>
                      En
                    </Link>
                    <span>|</span>
                    <Link to='/' className='text-white rounded-sm p-1.5'>
